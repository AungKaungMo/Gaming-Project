...
$(document).ready(function () {
  ...
  $(".addingProductList").click(function () {
    ...
    localStorage.setItem(
      "localArrayForBought",
      JSON.stringify(localArrayForBought)
    );
...
function loadingPrepare(appendListBox, arrayName, arr) {
  ...
  for (let i = 0; i < localArrayParse.length; i++) {
    addingList(
      appendListBox,
      localArrayParse[i].localImage,
      localArrayParse[i].localName,
      localArrayParse[i].localPrice,
      localArrayParse[i].localId
    );
  }
}
    ...
    `<div class="favBox mt-3 text-light" id="${count}">
        <div class="favBoxContainer d-flex">
          <div class="image ms-2 ">
            <img src="${img}" width="100%" height="100%" style= "object-fit: cover;">
          </div>
